...
class TestDiscount(TransactionCase):
    ...
    def test_01(self):
        ...
        invoice.invoice_line_ids = ([(0, 0, {
            ...
            'l10n_cr_edi_total_discount': 0.5,
        }), (0, 0, {
            'name': 'Product 002',
            'product_id': self.product.id,
            'quantity': 4.0,
            'price_unit': 11.73,
            'account_id': account.id,
            'l10n_cr_edi_total_discount': 1.41,
        })])
        ...
        self.assertEqual(
            round(invoice_dict['l10n_cr_edi_total_discount'],
    ...
    def test_02_compute_discount(self):
        ...
        invoice._compute_discount()
        self.assertEqual(round(invoice.l10n_cr_edi_total_discount, discount_digits), 1652.66)
